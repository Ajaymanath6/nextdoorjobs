...
const pincodeData = [
  ...
  {
    pincode: "691004",
    localityName: "Kilikollur / Karicode",
    latitude: 8.9050,
    longitude: 76.6310,
    district: "Kollam",
    state: "Kerala",
...
async function seedKollam() {
  console.log("🌱 Starting to seed Kollam pincodes...");
  ...
  try {
    ...
    try {
      ...
      console.log(`📊 Existing Kollam pincodes in database: ${existingCount}`);
    } catch (error) {
    ...
    try {
      ...
      console.log(`📍 District: Kollam, State: Kerala`);
    ...
    // Display all Kollam pincodes after insertion (with timeout handling)
    try {
      ...
      console.log(`\n📋 Total Kollam pincodes in database: ${allPincodes.length}`);
      console.log("\n📋 All Kollam Pincodes:");
