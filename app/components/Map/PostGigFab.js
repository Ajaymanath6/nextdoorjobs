...
export default function PostGigFab({ accountType }) {
  ...
  return (
    <button
      ...
      className="fixed right-6 bottom-6 z-[1500] flex items-center gap-2 rounded-full border border-brand-stroke-weak bg-white px-4 py-2.5 shadow-md transition-all hover:bg-brand-bg-fill hover:shadow-lg active:scale-[0.98] md:right-8 md:bottom-8"
      aria-label={label}
      title={label}
